...
class UseR1C1FormulaTests: TestCaseBase {
    func testUseR1C1Formula() throws {
        try TestUtil.licenseKey()
        let outputFile = TestUtil.OutputPath + "Demo/UseR1C1Formula.xlsx"
        ...
        // Check data
        // let baseLineFile = TestUtil.BaseLinePath + "Demo/UseR1C1Formula.xlsx"
