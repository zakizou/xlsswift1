...
class FormatAColumnTests: TestCaseBase {

    func testFormatAColumn() throws {
        try TestUtil.licenseKey()
        let outputFile = TestUtil.OutputPath + "Demo/FormatAColumn.xlsx"
        ...
        try sheet.get_Columns().get_Item(0).set_CellStyleName(style.get_Name())

        try sheet.get_Columns().get_Item(0).set_Text("Test")
        ...
        // Check data in xlsx
        // let baseLineFile = TestUtil.baseLinePath + "Demo/FormatAColumn.xlsx"
